...
<meta name="keywords" content="PHP组件,PHP探针,UPUPW,ZendGuardLoader,eAccelerator,memcache" />
<meta name="description" content="UPUPW PHP环境集成包PHP探针可检测包括Apache和Nginx服务器套件的ZendGuardLoader,eAccelerator和memcache等PHP组件。" />
...
<table class="info tablex2">
  ...
  <tr>
    <td width="150" class="er" >ZendLoader 支持</td>
    <td width="350" class="fl"><?=function_exists('zend_loader_version') ? YES : NO ?></td>
  </tr>
  
    <tr>
    <td class="er">eAccelerator 支持</td>
    <td class="fl"><?=function_exists('eaccelerator_info') ? YES.' / '.get_ea_info('version') : NO ?></td>
  </tr>
  ...
  <tr>
    ...
    <td class="fl"><?=function_exists('gd_info') ? YES.' / '.get_gd_info('GD Version') : NO ?></td>
  </tr>
